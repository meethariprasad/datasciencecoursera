...
# #Step3:Ensemble using Approximate Weighted Average (Or NN with 1 hiddenlayer?)========
            ...
            submit.predict.bestdl1$predict<-ifelse(submit.predict.bestdl1$predict<0,6,submit.predict.bestdl1$predict)
            ...
            submit.predict.bestdl2$predict<-ifelse(submit.predict.bestdl2$predict<0,6,submit.predict.bestdl2$predict)
            ...
            submit.predict.bestdl$predict<-(0.8*submit.predict.bestdl1$predict
                                          +0.2*submit.predict.bestdl2$predict)
...
# #Step4:Submission========
            ...
            write.csv(predict.bestdl,"bfv2.csv",row.names = F)
